...
@section('contents')
    ...
    <main>
        @include('msg')
        <form id="listForm" method="post" action="{{ route('manageAgentUpdate') }}">
            @csrf
                        ...
                        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <tr>
                                            <td class="px-3 py-4 whitespace-nowrap text-sm font-medium border">
                                                ...
                                                <div class="px-2 py-2 border w-full border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-green-500 focus:border-green-500">
                                            		@if ( $agent["status"] == 0 ) 
                                                		契約中
                                            		@else
                                                		解約
                                ...
                                <table id="detailTable1" class="min-w-full divide-y divide-gray-200">
                                    <thead class="bg-green-500">
                                        <tr>
                                            <th scope="col" class="px-3 py-3 text-left text-xs font-medium text-white border" width="10%">
                                                郵便番号
                                            </th>
                                            <th scope="col" class="px-3 py-3 text-left text-xs font-medium text-white border" width="10%">
                                                都道府県名
                                            </th>
                                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-white border" width="%60">
                                                住所
                                            </th>
                                        </tr>
                                    </thead>
