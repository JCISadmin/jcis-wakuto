...
<main>
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
		...
		<form method="post" action="{{ route('manageAgentUsageStatusSearch2') }}">
            ...
            <div class="flex pt-4">
                <div class="flex-initial px-4">
                    <label for="searchDate">対象年月</label>
                    <input type="month" value="{{ $targetMonth }}" name="targetMonth" id="targetMonth" class="px-2 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-green-500 focus:border-green-500">
                </div>
                <div class="flex-initial px-4">
                    <label for="contractPlan">契約プラン</label>
                    <select name="contractPlan" id="contractPlan" class="border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-green-500 focus:border-green-500">
                ...
                <div class="flex-initial px-4">
                    ...
                    <select name="dispType" id="dispType" class="border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-green-500 focus:border-green-500">
        ...
        <div class="flex max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            ...
            <div class="w-1/2 text-right">
                <div class="inline-flex">
                    <div class="w-2"></div>
                    <button type="button" onclick="location.href = '{{ route('manageAgentUsageStatusListCsv') }}';" class="px-6 py-2 justify-center border border-transparent rounded-md shadow-sm font-medium text-white bg-green-500 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-400">
                        CSVダウンロード
                    </button>
                </div>
            </div>
