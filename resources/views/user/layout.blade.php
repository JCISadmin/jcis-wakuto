                ...
                <div class="flex items-center justify-between h-10">
                    ...
                    <div>
                        <div class="ml-4 flex items-center md:ml-6">
                            <div class="ml-3 relative">
                                <span class="text-white px-3 py-2 rounded-md text-base font-medium">
                                    <a href="{{config('hds.url.footer.companyInfo')}}" target="_blank" rel="noopener noreferrer"
                                        class="text-white hover:bg-green-400 hover:bg-opacity-75 px-3 py-2 rounded-md text-base font-medium">
                                        会社案内
                                    </a>
                                </span>
                            ...
                            <div class="ml-3 relative">
                                <span class="text-white px-3 py-2 rounded-md text-base font-medium">
                                    <a href="{{config('hds.url.footer.privacy')}}" target="_blank" rel="noopener noreferrer"
                                        class="text-white hover:bg-green-400 hover:bg-opacity-75 px-3 py-2 rounded-md text-base font-medium">
                                        プライバシー
                                    </a>
                                </span>
                            ...
                            <div class="ml-3 relative">
                                <span class="text-white px-3 py-2 rounded-md text-base font-medium">
                                    <a href="{{config('hds.url.footer.terms')}}" target="_blank" rel="noopener noreferrer"
                                        class="text-white hover:bg-green-400 hover:bg-opacity-75 px-3 py-2 rounded-md text-base font-medium">
                                        利用規約
                                    </a>
                                </span>
