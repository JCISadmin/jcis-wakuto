...
@section('contents')
    <main>
        ...
        <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            <form method="post" action="{{ route('userSearchSearch') }}">
                @csrf
                    ...
                    <div class="w-full grid grid-cols-2 gap-2">
                        @for ($i = 0; $i < 10; $i++)
                            <div class="border w-full">
                                <label>
                                    <input type="text" placeholder="法人名" maxlength="20" value="" name="companyName[]"
                ...
                <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="w-full grid grid-cols-2 gap-2">
                        @for ($i = 0; $i < 10; $i++)
                            <div class="border w-full">
                                <label>
                                    <input type="text" placeholder="個人名" maxlength="20" value="" name="parsonName[]"
                                           class="w-full px-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-green-500 focus:border-green-500">
                                </label>
                            </div>
                        @endfor
                ...
                <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex">
                        <div class="flex-initial px-4">
                            ...
                            <input type="checkbox" name="fuzzyFlg" id="fuzzyFlg" value="{{ old('fuzzyFlg') }}">
