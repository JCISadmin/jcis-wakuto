...
<table>
    ...
    <tr>
        <td colspan="5" style="width: 380px; height: 40px; font-size: 20px;">請 求 書</td>
    ...
    <tr>
        ...
        <td colspan="3" style="width: 190px;" class="header">{{$companyInfo['name']}}</td>
    ...
    <tr>
        <td colspan="3" style="width: 270px;" class="header"></td>
        <td colspan="3" style="width: 190px;" class="header">TEL：{{$companyInfo['tel']}}</td>
        <td colspan="1" style="width: 80px;" class="header"></td>
    </tr>
    <tr>
        <td colspan="3" style="width: 270px;" class="header"></td>
