    ...
    'registrySearch' => [
        'upload' => [
            'note' => 
                ...
                アップロード可能なファイルは、登記簿PDFファイル、複数登記簿PDFを格納したzipファイル、確認画面でダウンロード可能なCSVファイルとなります。
                登記簿PDFは10ファイル1,000件が上限となります。上限を超える件数を検索したい場合は分割のご対応をお願いします。
                登記簿PDFは「一般財団法人民亊法務協会」が提供する「商業・法人登記情報PDF」のみに対応しています。それ以外の形式では正常に読み取れませんのでご注意ください。',
        ],
        'confirm' => [
            //<BR>で改行
            'note' => 
