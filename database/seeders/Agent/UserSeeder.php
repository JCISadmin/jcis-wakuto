    ...
    public function run()
    {
        ...
        for ($i = 1; $i <= 25; $i++) {
            ...
            DB::table('mUserCompany')->insert([
                'companyId' => sprintf('sub%02d', $i),
                'name' => sprintf('代理店%02d %s', $i, $this->planAry[($i-1)%6]['name']),
            ...
            DB::table('tContractPlan')->insert([
                ...
                'contractTypeId' => 0,
                'startTrial' => '2024-01-01',
                'useStartDate' => '2024-09-01',
                'useUpdateDate' => '2024-09-01',
                'useEndAlertDate' => '2025-12-01',
            ...
            DB::table('mUserDetail')->insert([
                'companyId' => sprintf('sub%02d', $i),
                'contractPlanId' => $this->planAry[($i-1)%6]['after']['planId'],
                'userId' => sprintf('jcis-sub%02d-001', $i),
                'password' => 0000,
                'name' => 'WEB担当者01',
                'departmentJob' => '開発部',
                'mail' => sprintf('jcis-sub%02d-001@entrend.net', $i),
            ...
            DB::table('mUserDetail')->insert([
                'companyId' => sprintf('sub%02d', $i),
                'contractPlanId' => $this->planAry[($i-1)%6]['after']['planId'],
                'userId' => sprintf('jcis-sub%02d-002', $i),
                'password' => 0000,
                'name' => 'WEB担当者02',
                'departmentJob' => '開発部',
                'mail' => sprintf('jcis-sub%02d-002@entrend.net', $i),
                'idMailBcc' => 'id_bcc@entrend.net',
                'loginDatetime' => null,
                'lockFlg' => 0,
                'delFlg' => 0,
            ...
            DB::table('mUserDetail')->insert([
                'companyId' => sprintf('sub%02d', $i),
                'contractPlanId' => 'api',
                'userId' => sprintf('jcisapi-sub%02d-001',$i),
                'password' => 0000,
                'name' => 'API担当者01',
                'departmentJob' => '開発部',
                'mail' => sprintf('jcisapi-sub%02d-001@entrend.net', $i),
                'idMailBcc' => 'id_bcc@entrend.net',
                'loginDatetime' => null,
                'lockFlg' => 0,
                'delFlg' => 0,
            ...
            DB::table('mUserDetail')->insert([
                'companyId' => sprintf('sub%02d', $i),
                'contractPlanId' => 'api',
                'userId' => sprintf('jcisapi-sub%02d-002',$i),
                'password' => 0000,
                'name' => 'API担当者02',
                'departmentJob' => '開発部',
                'mail' => sprintf('jcisapi-sub%02d-002@entrend.net', $i),
                'idMailBcc' => 'id_bcc@entrend.net',
                'loginDatetime' => null,
                'lockFlg' => 0,
                'delFlg' => 0,
