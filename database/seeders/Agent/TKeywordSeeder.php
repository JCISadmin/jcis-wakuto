        ...
        for ($companyId = 1; $companyId <= 6; $companyId++) {
            ...
            for ($userId = 1; $userId <= 2; $userId++) {
                ...
                foreach ($period as $date) {
                    ...
                    // 2025/01/01以降 プランを変更
                    if ( $date >= new \DateTime('2025-01-01') ) {
                    ...
                    DB::table('tKeywordHistory')->insert([
                        'companyId' => sprintf('sub%02d', $companyId),
                        'contractPlanId' => $webContractPlanId,
                        'userId' => sprintf('jcis-sub%02d-%03d', $companyId, $userId),
                        'hash' => uniqid(),
                    ...
                    if ($companyId <= 2) {
                        ...
                        DB::table('tKeywordHistory')->insert([
                            'companyId' => sprintf('sub%02d', $companyId),
                            'contractPlanId' => 'api',
                            'userId' => sprintf('jcisapi-sub%02d-%03d', $companyId, $userId),
                            'hash' => uniqid(),
                            'expireDate' => $date->format('YmdHisv'),
                            'keyword' => uniqid(),
                            'searchDate' =>  $date->format('Y-m-d'),
